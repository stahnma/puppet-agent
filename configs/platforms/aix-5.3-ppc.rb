platform "aix-5.3-ppc" do |plat|
  ...
  plat.install "/opt/freeware/bin/install"
  ...
  plat.provision_with "rm -rf /opt/pl-build-tools /opt/puppetlabs /etc/puppetlabs /var/log/puppetlabs /var/tmp/tmp.* /var/tmp/*root-root /var/tm    p/rpm* /root/*.jam"
